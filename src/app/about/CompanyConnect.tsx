      ...
      <div className="bg-ikwp-purple rounded-4xl p-12.5 w-full flex justify-between">
        <div className="w-1/2 flex flex-col text-left justify-between text-white">
          ...
          <div className="flex flex-col justify-end">
            <a href="/" className="w-fit flex place-items-center items-center justify-center bg-ikwp-orange-1 text-white font-semibold text-[43px] px-12 py-4.5 rounded-full gap-6">
              Connect with us
              <Image 
